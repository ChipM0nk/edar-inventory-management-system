...
type Querier interface {
	...
	CountWarehousesWithFilter(ctx context.Context, arg *CountWarehousesWithFilterParams) (int64, error)
	...
	ListWarehousesWithFilter(ctx context.Context, arg *ListWarehousesWithFilterParams) ([]*Warehouse, error)

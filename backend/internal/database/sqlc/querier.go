...
type Querier interface {
	...
	GetDocumentsByPurchaseOrder(ctx context.Context, referenceID pgtype.UUID) ([]*Document, error)
	GetDocumentsByReference(ctx context.Context, arg *GetDocumentsByReferenceParams) ([]*Document, error)
	GetDocumentsByTypeOnly(ctx context.Context, referenceType string) ([]*Document, error)
